...
public class GameState {
    ...
    public boolean equals(Object o) {
        ...
        return Arrays.deepEquals(board, gameState.board);  // Compare the board states
    }

    @Override
    public int hashCode() {
        return Arrays.deepHashCode(board);  // Use the board state for hashing
    }
...
//        if (!Arrays.deepEquals(board, gameState.board)) {
//            return false;
//        }
//
//        // Check if the colored squares are identical
//        return Objects.equals(coloredSquares, gameState.coloredSquares);
//    }
//
//    @Override
//    public int hashCode() {
//        // Combine the hash codes of the board and colored squares
//        int result = Arrays.deepHashCode(board);
//        result = 31 * result + Objects.hashCode(coloredSquares);
//        return result;
//    }
}
